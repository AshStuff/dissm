...
class Abstract3DUNet(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid, basic_module, f_maps=64, layer_order='gcr',
        ...
        nn.init.normal_(self.final_conv.weight, 0, 0.01)
...
if __name__ == '__main__':
    ...
    model = UNet3D(in_channels=2, out_channels=1, final_sigmoid=False, is_segmentation=False).cuda()
    print(model)
    var = torch.randn(1, 2, 128, 112, 88).cuda()
